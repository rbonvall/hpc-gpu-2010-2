...
DEPLOYDIR = $(HOME)/public_html/hpc-gpu-2010-2
...
qthelp:
	...
	@echo "# qcollectiongenerator _build/qthelp/ProgramacinTest.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile _build/qthelp/ProgramacinTest.qhc"
